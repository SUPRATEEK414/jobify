function footer() {
  ...
  <div>
    <ul>
      ...
      <li><a href="#">Selling on Jobify</a></li>
      <li><a href="#">Buying on Jobify</a></li>
    </ul>
  </div>
  ...
  <div>
    <ul>
      <li><h4>More From Jobify</h4></li>
      <li><a href="#">Jobify Business</a></li>
      <li><a href="#">Jobify Pro</a></li>
      <li><a href="#">Jobify Studios</a></li>
      <li><a href="#">Jobify Logo Maker</a></li>
      <li><a href="#">Jobify Guides</a></li>
      <li><a href="#">Get Inspired</a></li>
      <li><a href="#">Jobify Select</a></li>
      <li><a href="#">ClearVoice <br><span>Content Marketing</span></a></li>
      <li><a href="#">Jobify Workspace<br><span>Invoice Software</span></a></li>
